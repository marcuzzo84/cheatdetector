/*
  # Drop unused indexes to optimize database performance

  1. Unused Indexes
     - `idx_uploaded_files_file_type` - Never utilized in queries
     - `idx_uploaded_files_processed` - Low cardinality column with limited query benefit
