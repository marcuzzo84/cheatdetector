...
-- Create helper functions that also use SECURITY INVOKER with fixed search_path
...
-- Function to get recent high-risk games (respects RLS) - with new signature
...
BEGIN
    ...
    RAISE NOTICE '- Fixed search_path parameter ensures intended schema context';
    RAISE NOTICE '';
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Available Functions (SECURITY INVOKER with fixed search_path):';
