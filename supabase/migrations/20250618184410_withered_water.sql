/*
  ...
  1. Tables
    - `otp_requests` - Tracks OTP requests for rate limiting and security monitoring
    - `security_events` - Logs security events and suspicious activities
  ...
  3. Functions
    - `check_otp_rate_limit()` - Enforces rate limits
    - `log_otp_request()` - Logs and monitors OTP usage
    - `get_otp_security_status()` - Admin monitoring dashboard
    - `cleanup_expired_otp_requests()` - Maintenance function
*/
